...
In this condition the robot gets presented images with a random amount of the patterns covered.
"""
...
class ImageSlideshow(QWidget):
    ...
    def after_capture_processing(self):
        ...
        #self.timer.stop() #Anna: we are not done yet, why is this here?
    ...
    def handle_button(self, result):
        ...
        if result:
            ...
            if visibility_value == constants['visibility_maximum']:
                new_visibility_value = visibility_value
                print('Upper limit of visibility is achieved. Visibility value remains ' + str(new_visibility_value))
            else:
